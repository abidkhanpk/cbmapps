...
async function main() {
    ...
    const passwordHash = await bcrypt_1.default.hash('Admin@12345', 10);
    ...
    const engineerUser = await prisma.user.upsert({
        ...
        create: {
            ...
            passwordHash: await bcrypt_1.default.hash('Engineer@123', 10),
    ...
    const technicianUser = await prisma.user.upsert({
        ...
        create: {
            ...
            passwordHash: await bcrypt_1.default.hash('Tech@123', 10),
